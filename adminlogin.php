...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                       ...
                       <!-- <a href="about.html" class="nav-item nav-link">Tracker</a>
                    ...
                    <!--<a href="" class="btn btn-primary py-2 px-4">DELIVERY</a>-->
                </div>
            </nav>
        ...
        <form action="admindisplayorder.php" method="post">
        <!-- Reservation Start -->
            ...
            <div class="row g-0">
                ...
                <div class="col-md-12 bg-dark d-flex align-items-center ">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Admin Login</h5>
                        <h6 class="text-white mb-4">Kindly fill in your details</h6>
                        
                            <div class="row g-3">

                                <div class="col-md-6">
                                    <div class="form-floating date" data-target-input="nearest">
                                        <input type="text" name="user_name" min="0" class="form-control"  placeholder="user_name" required>
                                        <label for="phone_number">User name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
